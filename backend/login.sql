...
--
-- Host: localhost:3306
-- Generation Time: Sep 03, 2020 at 06:06 PM
...
CREATE TABLE `korisnici` (
  ...
  `ime` tinytext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `sifra` longtext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `godine` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `ovlascenje` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
...
DROP TABLE IF EXISTS `passwordrestart`;
...
CREATE TABLE `pesme` (
  ...
  `lajkova` int DEFAULT NULL,
  `lajkovao` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
