...
if($ovlascenje=="nelogovan"){
  ...
  if(in_array($_SESSION["ime"], $niz)){
    echo '<div onclick="lajkuj('.$red["id"].","."'".$_SESSION["ime"]."')".'"'. ' class="srce"><img src="fajlovi/srce-puno.png"><span id="' .$red["id"] . 'brojlajkova">' . $red["lajkova"] .'</div><div class="vreme-tekst">' . $vreme . '</div> <div onclick="prikazikomentare('.$red["id"].')" class="ikonicazakomentarkontejner"><img class="ikonicazakomentar" src="fajlovi/komentar.svg" /> </div>';
  }
  else{
    echo '<div onclick="lajkuj('.$red["id"].","."'".$_SESSION["ime"]."')".'"'. ' class="srce"><img src="fajlovi/srce-prazno.svg"><span id="' .$red["id"] . 'brojlajkova">' . $red["lajkova"] .'</div><div class="vreme-tekst">' . $vreme .'</div> <div onclick="prikazikomentare('.$red["id"].')" class="ikonicazakomentarkontejner"><img class="ikonicazakomentar" src="fajlovi/komentar.svg" /> </div>';
  }
}
echo '</div></div>';
}